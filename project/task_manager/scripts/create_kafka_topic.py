...
from app.infrastrucrute.kafka.avro_models import TaskAssignedEvent, TaskCompletedEvent
...
if __name__ == "__main__":
    ...
    topics: dict[type[AvroModel], tuple[str, str]] = {
        TaskAssignedEvent: (
            KafkaTopicsEnum.task_assigned,
            KafkaTopicsEnum.task_assigned.get_schema_name(),
        ),
        TaskCompletedEvent: (
            KafkaTopicsEnum.task_completed,
            KafkaTopicsEnum.task_completed.get_schema_name(),
        )
    }
